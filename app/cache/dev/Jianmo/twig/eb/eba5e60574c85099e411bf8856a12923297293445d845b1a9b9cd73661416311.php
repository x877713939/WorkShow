  ...
  <div class=\"dropdown-menu user-dropdown hidden-sm hidden-xs hidden-md js-user-nav-dropdown\">
    <div class=\"user-dropdown-info cd-mb24\">
      ...
      <div class=\"user-dropdown-profile\">
        ...
        {{ slot('header.user.info', {user: app.user}) }}sdfs
      </div>
    </div>
    <div class=\"user-dropdown__link cd-mb24\">
...
</li>", "default/header/part/user-avatar.html.twig", "/var/www/bootcamp/chenlong/project-it-migrant-workers/app/Resources/views/default/header/part/user-avatar.html.twig");
    }
}
