...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('Bb+T5FfjHr', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('oRh9GlXS7f', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Ts9PC2Xfbc', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0UcMxfK-rJ', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('aV2qdWT-zj', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['codeages_plugin.slot_collector'] = new \Codeages\PluginBundle\System\Slot\SlotInjectionCollector([0 => ($this->targetDirs[4].'/plugins/WorkshowPlugin/Resources/config/slots.yml')], $this->targetDirs[0], true);
    }
    ...
    {
        return $this->services['codeages_plugin.slot_manager'] = new \Codeages\PluginBundle\System\Slot\SlotManager(${($_ = isset($this->services['codeages_plugin.slot_collector']) ? $this->services['codeages_plugin.slot_collector'] : ($this->services['codeages_plugin.slot_collector'] = new \Codeages\PluginBundle\System\Slot\SlotInjectionCollector([0 => ($this->targetDirs[4].'/plugins/WorkshowPlugin/Resources/config/slots.yml')], $this->targetDirs[0], true))) && false ?: '_'}, $this);
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $a->addPath(($this->targetDirs[4].'/src/ApiBundle/Resources/views'), '!Api');
        $a->addPath(($this->targetDirs[4].'/plugins/WorkshowPlugin/Resources/views'), 'WorkshowPlugin');
        $a->addPath(($this->targetDirs[4].'/plugins/WorkshowPlugin/Resources/views'), '!WorkshowPlugin');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'WorkshowPlugin' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[4].'/plugins/WorkshowPlugin'),
                    'namespace' => 'WorkshowPlugin',
                ],
                'WebProfilerBundle' => [
                    'parent' => NULL,
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'WorkshowPlugin' => 'WorkshowPlugin\\WorkshowPlugin',
