...
}]))->withContext('twig.template_cache_warmer', $this), new \Symfony\Bundle\TwigBundle\TemplateIterator(${($_ = isset($this->services['kernel']) ? $this->services['kernel'] : $this->get('kernel', 1)) && false ?: '_'}, $this->targetDirs[3], [($this->targetDirs[3].'/../web/customize') => 'customize', ($this->targetDirs[3].'/../src/Topxia/WebBundle/Resources/views') => 'topxiaweb', ($this->targetDirs[3].'/../web/themes') => 'theme', ($this->targetDirs[3].'/../plugins') => 'plugins', ($this->targetDirs[3].'/../') => 'root', ($this->targetDirs[3].'/../web/activities') => 'activity', ($this->targetDirs[4].'/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form') => NULL], ($this->targetDirs[4].'/templates')));
