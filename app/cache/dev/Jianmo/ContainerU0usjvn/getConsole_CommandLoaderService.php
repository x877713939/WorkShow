...
return $this->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\ServiceLocator(['bazinga.jstranslation.dump_command' => function () {
    $f = function (\Bazinga\Bundle\JsTranslationBundle\Command\DumpCommand $v) { return $v; }; return $f(${($_ = isset($this->services['bazinga.jstranslation.dump_command']) ? $this->services['bazinga.jstranslation.dump_command'] : $this->load('getBazinga_Jstranslation_DumpCommandService.php')) && false ?: '_'});
