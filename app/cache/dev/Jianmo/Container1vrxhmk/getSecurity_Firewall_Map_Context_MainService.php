...
$c = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $b, new \AppBundle\Handler\LogoutSuccessHandler($b, '/'), ['csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'logout']);
