...
}]))->withContext('twig.template_cache_warmer', $this), new \Symfony\Bundle\TwigBundle\TemplateIterator(${($_ = isset($this->services['kernel']) ? $this->services['kernel'] : $this->get('kernel', 1)) && false ?: '_'}, $this->targetDirs[2], [($this->targetDirs[2].'/../web/customize') => 'customize', ($this->targetDirs[2].'/../src/Topxia/WebBundle/Resources/views') => 'topxiaweb', ($this->targetDirs[2].'/../web/themes') => 'theme', ($this->targetDirs[2].'/../plugins') => 'plugins', ($this->targetDirs[2].'/../') => 'root', ($this->targetDirs[2].'/../web/activities') => 'activity', ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form') => NULL], ($this->targetDirs[3].'/templates')));
